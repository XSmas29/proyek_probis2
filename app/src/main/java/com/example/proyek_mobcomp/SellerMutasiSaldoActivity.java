...
import com.example.proyek_mobcomp.databinding.ActivitySellerMutasiSaldoBinding;
...
public class SellerMutasiSaldoActivity extends AppCompatActivity {

    ActivitySellerMutasiSaldoBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySellerMutasiSaldoBinding.inflate(getLayoutInflater());
    ...
    private void SetupRvMutasiSaldo(ArrayList<cMutasi> listMutasi) {
        binding.rvMutasiSaldoSeller.setLayoutManager(new LinearLayoutManager(this));
        binding.rvMutasiSaldoSeller.setHasFixedSize(true);
        System.out.println(listMutasi.size());
        recyclerAdapterMutasiSaldo = new RecyclerAdapterMutasiSaldo(listMutasi);
        binding.rvMutasiSaldoSeller.setAdapter(recyclerAdapterMutasiSaldo);
    }
}