...
import com.example.proyek_mobcomp.databinding.FragmentAdminConfWithdrawBinding;
import com.example.proyek_mobcomp.recyclerviewFolder.RecyclerAdapterAdminConfTopUp;
import com.example.proyek_mobcomp.recyclerviewFolder.RecyclerAdapterAdminConfWithdraw;
 ...
 * Use the {@link AdminConfWithdrawFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminConfWithdrawFragment extends Fragment {
    ...
    public AdminConfWithdrawFragment() {
    ...
    public static AdminConfWithdrawFragment newInstance(String param1, String param2) {
        AdminConfWithdrawFragment fragment = new AdminConfWithdrawFragment();
    ...
    private FragmentAdminConfWithdrawBinding binding;

    ArrayList<cTopup> arrTopUp = new ArrayList<>();

    RecyclerAdapterAdminConfWithdraw recyclerAdapterAdminConfWithdraw;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        //return inflater.inflate(R.layout.fragment_admin_conf_withdraw, container, false);

        binding = FragmentAdminConfWithdrawBinding.inflate(inflater, container, false);
    ...
    public void getTopUpData() {
        ...
        StringRequest stringRequest = new StringRequest(
                Request.Method.POST,
                getResources().getString(R.string.url) + "/admin/getwithdrawdata",
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        System.out.println("error get withdraw data in conf fragment " + error);
                    }
                }
        ){
            @Nullable
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("function", "getwithdrawdata");
                return params;
            }
        };
    ...
    protected void setRv(ArrayList<cUser> arrUser) {
        binding.recyclerViewMasterWithdraw.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.recyclerViewMasterWithdraw.setHasFixedSize(true);

        recyclerAdapterAdminConfWithdraw = new RecyclerAdapterAdminConfWithdraw(
                arrTopUp, arrUser
        );
        binding.recyclerViewMasterWithdraw.setAdapter(recyclerAdapterAdminConfWithdraw);
